...
- [x] **Prompts API 테스트** ✅ 🆕
  - **파일**: `backend/tests/test_prompts_api.py` 완성 (14 tests)
  - **테스트 대상**:
    - ✅ 공개 프롬프트 목록 조회 (빈 목록, 공개/비공개 필터링)
    - ✅ 프롬프트 생성 (공개/비공개)
    - ✅ use_count 기준 정렬 (내림차순)
    - ✅ 페이지네이션 (page, page_size)
    - ✅ 인증 검증 (401/403)
    - ✅ 입력 검증 (422)
  - **완료 기준**: ✅ Prompts API 엔드포인트 완전 커버
  - **커버리지 개선**: `app/api/v1/prompts.py` 57% → (예상 90%+)
